...
{
    public class TableRowsIterater : HubSpotIteraterBase
    {
        private readonly Table _table;
        private readonly long _portalId;

        public TableRowsIterater(IHubSpotClient client, HubSpotCrawlJobData jobData, Table table, long portalId) : base(client, jobData)
        {
